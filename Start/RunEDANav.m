function[AllStat,Cache]=RunEDA(PopSize,X0,F,Card,cache,edaparams) 
...
% X0: one element of the population
...
while(continue_evolution==1)
 ...
 t = cputime;    
     ...
     if k==1
      ...
      for i=1:NewPopSize,
           [sc, sci] = feval(F,NewPop(i,:));  
           NewPopFunVal(i,:) = -log(sc);
      end
