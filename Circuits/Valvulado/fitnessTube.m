...
%7
BplusPower= ParDados{8, 2};
BplusPowerMax= scoreAvPar(1, BplusPower);
%8
BplusPre= ParDados{7, 2};
BplusPreMax= scoreAvPar(1, BplusPre);
%9
BminuGrid= ParDados{9, 2};
BminuGridMax= scoreAvPar(1, BminuGrid);
%10
BminuTail= ParDados{10, 2};
BminuTailMax= scoreAvPar(1, BminuTail);
