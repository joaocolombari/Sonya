function paramAC(circuito, x, mode, reltol)
...
%   reltol   - relative error tolerance for ltspice compression 
%
...
elseif nargin < 4
    reltol = 0.001;     % default error tolerance
end
